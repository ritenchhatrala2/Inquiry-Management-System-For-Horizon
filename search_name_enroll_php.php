<?php
	...
	$s_name=$_POST['s_name'];
	$q=mysql_query("select * from inquiry where NAME like '%$s_name%' AND ALIVE='1'");
	$r=mysql_num_rows($q);
...
<body>
			...
			<div class="container_24" align="center">
                ...
                <div class="backlink" align="center">
                    ...
                    <a href="search_name_enroll.html"><button name="Search-by-name" class="styled-button">Back</button></a>
                    </div>
				 <br/>
                ...
                <br/>
                    <div class="backlink" align="center">
                    <a href="index.html#enroll"><button name="Menu" class="styled-button">Menu</button></a>
                    <a href="search_name_enroll.html"><button name="Search-by-name" class="styled-button">Back</button></a></div>
