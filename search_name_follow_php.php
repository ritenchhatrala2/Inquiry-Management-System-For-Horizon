...
<body>
			...
			<div class="container_24" align="center">
                ...
                <div class="backlink" align="center">
                    ...
                    <a href="search_name_follow.html"><button name="Search-by-name" class="styled-button">Back</button></a>
                    </div>
				 <br/>
                ...
                <br/>
                    <div class="backlink" align="center">
                    <a href="index.html#followup"><button name="Menu" class="styled-button">Menu</button></a>
                    <a href="search_name_follow.html"><button name="Search-by-name" class="styled-button">Back</button></a></div>
