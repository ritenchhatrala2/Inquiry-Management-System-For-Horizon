<?php
	...
	$s_date=$_POST['s_date'];
	$t_date=$_POST['t_date'];
	$q=mysql_query("select * from inquiry where DATE between '$s_date' and '$t_date' AND ALIVE='1' ");
	$r=mysql_num_rows($q);
...
<div class="container_24" align="center">
		...
		<div class="logo">
 	 	...
 	 	<div class="backlink">
            ...
            <a href="search_date.html"><button name="Search-by-name" class="styled-button">Back</button></a>
       	</div>
        ...
        <div class="backlink">
        	<a href="index.html"><button name="Menu" class="styled-button">Menu</button></a>
        	<a href="search_date.html"><button name="Search-by-name" class="styled-button">Back</button></a></div>
