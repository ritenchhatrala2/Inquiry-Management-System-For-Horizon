<?php
	...
	$s_date=$_POST['s_date'];
	$t_date=$_POST['t_date'];
	$q=mysql_query("select * from inquiry where FOLLOW_UP between '$s_date' and '$t_date' AND ALIVE='1'");
	$r=mysql_num_rows($q);
...
<body>
			...
			<div class="container_24" align="center">
                ...
                <div class="backlink" align="center">
                    ...
                    <a href="search_date_follow.html"><button name="Search_date" class="styled-button">Back</button></a>
                    </div>
				 <br/>
                ...
                <br/>
                    <div class="backlink" align="center">
                    <a href="index.html#followup"><button name="Menu" class="styled-button">Menu</button></a>
                    <a href="search_date_follow.html"><button name="Search-by-name" class="styled-button">Back</button></a></div>
