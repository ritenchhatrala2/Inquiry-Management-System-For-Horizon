<?php
	...
	$q=mysql_query("select * from student_info where ENROLLED='1'");
	$r=mysql_num_rows($q);
                ...
                <?php
					...
					if($r>0)
					{
						...
						while($row=mysql_fetch_array($q))
						{
							...
							<td>$row[46]</td>
							<td>$row[48]</td>
							<td><a href='update_std_info.php?id=$row[1]'><button name='fees' class='styled-button-table'>Update</button></a></td>
							</tr>";
						}
