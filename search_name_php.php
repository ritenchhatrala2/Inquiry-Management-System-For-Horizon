...
<div class="container_24" align="center">
		...
		<div class="logo">
 	 	...
 	 	<div class="backlink">
            ...
            <a href="search_name.html"><button name="Search-by-name" class="styled-button">Back</button></a>
       	</div>
        ...
        <div class="backlink">
        	<a href="index.html"><button name="Menu" class="styled-button">Menu</button></a>
        	<a href="search_name.html"><button name="Search-by-name" class="styled-button">Back</button></a></div>
